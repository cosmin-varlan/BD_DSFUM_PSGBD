--nici un index pe tabelele nou create
...
select * from emp, dept where dept.deptno = emp.deptno; --formulare echivalent?

----plan de executie join dupa creare index - ca urmare a declararii cheii primare ---------
alter table dept add constraint pki primary key (deptno);
